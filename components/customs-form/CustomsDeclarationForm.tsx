...
export default function CustomsDeclarationForm() {
    ...
    switch (step) {
      ...
      case 3:
        return !!(
          ...
          formData.importerPAN &&
          formData.importerIEC &&
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 1:
        return (
          <ShipmentDetailsStep data={formData} updateData={updateFormData} />
        );
      case 2:
        return (
          <InvoiceHSCodeStep data={formData} updateData={updateFormData} />
        );
      case 3:
        return (
          <ConsigneeInfoStep data={formData} updateData={updateFormData} />
        );
      case 4:
        return (
          <ReviewSubmitStep
